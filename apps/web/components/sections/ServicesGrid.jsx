...
/* ──────────────────────────────────────────────────────
   ...
   the per-service routes; only the marks are defined here,
   since that data file carries no JSX.
   ────────────────────────────────────────────────────── */

// The icons sit on the sage back face of each card, so they inherit white
// rather than carrying the primary colour themselves.
const iconProps = {
  width: 40,
  height: 40,
  viewBox: '0 0 24 24',
